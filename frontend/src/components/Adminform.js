...
function Adminform() {
  ...
  const handleChange =(e) => {
    ...
    //   try {
    //     const response = await axios.post('http://localhost:5000/addAdmin', formData, {
    //       headers: {
    ...
    //       toast.success("Admin form submitted!");
  ...
  try {
    ...
    toast.success("Admin form submitted successfully!");
    navigate("/", { replace: true });

  } catch (error) {
    console.error("Admin submit error:", error.response?.data);
